...
# from /usr/lib/python2.7/dist-packages/psycopg2/_psycopg.so
# by generator 1.137
...
__version__ = '2.5.4 (dt dec mx pq3 ext)'
...
def Boolean(obj): # real signature unknown; restored from __doc__
...
def Decimal(obj): # real signature unknown; restored from __doc__
...
def Float(obj): # real signature unknown; restored from __doc__
...
def Int(obj): # real signature unknown; restored from __doc__
...
adapters = {
    ...
    (
        ...
        None # (!) forward: Decimal, real value is ''
    ,
}
